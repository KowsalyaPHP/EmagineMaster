...
export class JobDetailsComponent implements OnInit {
  ...
  constructor(private routerObj: Router, public jobDetailServiceObj: JobDetailsService, private formBuilderObj: FormBuilder, private loginService: LoginService, private route: ActivatedRoute) {
